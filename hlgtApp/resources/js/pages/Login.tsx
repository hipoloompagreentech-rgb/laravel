...
export default function Login() {
    ...
    const handleGoogleSignIn = async () => {
        ...
        try {
            ...
            // If res === null it means a redirect was initiated (fallback), so do nothing.
            if (res) {
                router.visit('/');
            }
        } catch (err: any) {
                ...
                <div className="max-w-md mx-auto px-4 sm:px-6 lg:px-8 w-full">
                    ...
                    <div className="mt-4">
                        <button
                            ...
                            disabled={loading}
                            className="w-full inline-flex items-center justify-center space-x-3 rounded-lg border border-slate-300 bg-white px-4 py-3 text-sm text-slate-800 hover:bg-slate-50"
                        >
